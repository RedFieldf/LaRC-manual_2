...
const manuals = {
    ...
    "p-isolation-work": {
        ...
        content: [
            ...
            },
            {
                type: 'step',
                list: [
                    { title: "心臓の摘出", sub: "<strong>ディッシュの配置：</strong><br>・左：<br>解剖機器を用いて、卵から胚を取り出し、胚から心臓を摘出。<br>摘出した心臓は、中央のシャーレに入った培地の中に入れる。<br>・中央：<br>心臓周辺についている組織を除去し、心臓内部に入った血液を抜く。<br>・右：<br>心臓を2, 3個の塊に切り刻む。<br>ただし、刃を入れすぎないよう注意すること。" },
                    ...
                    { title: "播種", sub: "※単離中に、Dishにコラーゲンを播種し、30 min 以上インキュベートしておく。<br><br>※インキュベーター内で揮発しきらなかった場合は、クリーンベンチ内にて風をあてて完全に揮発させる。<br><br>1. PBS (-) 1 ml をDish内に添加し、すぐアスピレーターで除去する。<br><br>2. DMEM 1 ml を入れ、Dish中心に向けて、細胞懸濁液を播種する。<br><br><strong>※参考の播種量：</strong><br>515 10 µl <br>545 20 µl" }
                ]
            }
        ]
    },
    ...
    "p-trypsin-mea": {
        ...
        content: [
            { type: 'note', title: '重要', text: 'PBS (-)およびトリプシンでの処理をサボると、カドヘリン（細胞接着因子）が除去できず、細胞が綺麗に剥がれません。' },
            {
                type: 'step',
                list: [
                    { title: "PBS Wash（2回）", sub: "1. 培地をアスピレーターで除去し、PBS (-) 1 ml を入れて、再度アスピレーターで除去。<br>2. これを <strong>2回</strong> 繰り返す。" },
                    { title: "トリプシン処理", sub: "プラカップに入れた水道水で解凍したトリプシン 500 µl を加え、<strong>10 min 以上</strong>インキュベーター内に放置する。" },
                    { title: "湯煎・乾燥", sub: "1. 細胞が剥がれていることを確認し、アスピレーターでトリプシン溶液を除去する。<br>2. お湯（DWで作製）でDishを洗う。<br>3. 時間がある場合はクリーンベンチ内で乾燥、時間がない場合はアスピレーターで水滴を完全に吸い取り、引き出し or 冷蔵庫で保存する。" }
                ]
            }
        ]
    },
    ...
    "p-cleanup-tools": {
        ...
        content: [
            ...
            { type: 'text', text: '<div class="step-sub">1. 透明バケツを使って洗浄液を捨て、MilliQで壁面を2回洗う。<br>2. 最後はキムタオルで拭く。<br>3. 蓋は洗う必要がないが、中にある金網はDWで洗い流した後、乾かす。</div>' },
            { type: 'sub-title', text: '④ ウォーターバス' },
            { type: 'text', text: '<div class="step-sub">1. 電源を切り、コンセントを抜き、水をすべて捨てる。<br>2. スターラー台は乾燥棚に置いて乾かす。</div>' }
        ]
    },
        ...
        content: [
            {
                ...
                list: [
                    { title: "元栓を開ける", sub: "" },
                    { title: "ペダルを踏んで着火", sub: "（火が弱かった場合）左の小さいバルブで調整する。" }
                ]
            }
        ]
    },
