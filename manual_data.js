    ...
    "p-trypsin-mea": {
        ...
        content: [
            { type: 'note', title: '重要', text: 'PBS (-)およびトリプシンでの処理をサボると、カドヘリン（細胞接着因子）が除去できず、細胞が綺麗に剥がれません。' },
            {
                type: 'step',
                list: [
                    { title: "PBS Wash（2回）", sub: "1. 培地をアスピレーターで除去し、PBS (-) 1 ml を入れて、再度アスピレーターで除去。<br><br>2. これを <strong>2回</strong> 繰り返す。" },
                    { title: "トリプシン処理", sub: "プラカップに入れた水道水で解凍したトリプシン 500 µl を加え、<strong>10 min 以上</strong>インキュベーター内に放置する。" },
                    { title: "湯煎・乾燥", sub: "1. 細胞が剥がれていることを確認し、アスピレーターでトリプシン溶液を除去する。<br><br>2. お湯（DWで作製）でDishを洗う。<br><br>3. 時間がある場合はクリーンベンチ内で乾燥、時間がない場合はアスピレーターで水滴を完全に吸い取り、引き出し or 冷蔵庫で保存する。" }
                ]
            }
        ]
    },
