...
const manuals = {
        ...
        content: [
            {
                type: 'step',
                list: [
                    { title: "準備", sub: "1. ヒートブロックを 65 ℃ 以上に設定（電子温度計をセットして温度を確認）。<br>2. Dish中央に青丸マーカーをつける。" },
                    { title: "アガロース溶解", sub: "ヒートブロックが 65 ℃ を超えたら、3 % LMPアガロースを入れて溶かす。<br>（※ 製品融点は60 ℃くらいだが、<strong>80 ℃を超えるまで</strong>は待つ。）" },
                    { title: "Dishの湿潤", sub: "Dishに 1 ml のMilliQを入れ、なるべく全て吸い取る。<br>（※ 表面を少し濡らすことで、アガロースを広がりやすくする。）" },
                    { title: "スピンコーター設定", sub: "ポンプおよび装置のスイッチをONにする。<br><strong>プログラム No. 3</strong> に設定する。<br>(500 rpm / 5 s →→→ 3000 rpm / 20 s)" },
                    { title: "塗布 (ここは素早く！！)", sub: "Dishをセットし、VACUUM MODEで固定する。<br>溶けて白濁していたものが透明になったアガロース 100 µl をDish中心に入れ、蓋をしてSTART。<br>※ Dishの端までアガロースが広がっていればOK。" },
                    { title: "乾燥", sub: "クリーンベンチ内で蓋を開け、風を当てて <strong>1 時間以上</strong>乾燥させる。<br>※乾燥不十分だと細胞が潜り込む原因になる。" }
                ]
            }
        ]
    },
    ...
    "p-collagen": {
        title: "コラーゲン調製・播種",
        content: [
            { type: 'note', title: '原理', text: 'コラーゲンは酸性（pH 3）の希塩酸で希釈して使用し、細胞が接着できるようにします。' },
            {
                type: 'step',
                list: [
                    { title: "希釈 (1 : 9)", sub: "エッペンチューブで混合する。<br><strong>コラーゲン：希塩酸 ＝ 1：9</strong><br>※混ざりやすくするため、量が多い希塩酸を後から入れる。" },
                    { title: "播種・インキュベート", sub: "Dish中央に真上から滴下し、<strong>30 min 以上</strong>インキュベート。<br><strong>目安滴下量は、515 = 10 µl、545 = 20 µl</strong>" },
                    { title: "乾燥・中性化", sub: "希塩酸が揮発して乾いていることを確認。<br>PBS (-) 1 ml を加え、アスピレーターで吸ってWashする（pHを中性に戻し、コラーゲンを繊維状態にする）。" },
                    { title: "培地添加", sub: "FBSありDMEM 1 ml を加え、細胞を播種する準備をする。<br>※細胞が底面に接着しやすくするため、最初は少なめの液量にする。" }
                ]
            }
        ]
    },
        ...
        content: [
            ...
            { type: 'sub-title', text: '③ 溶液の準備' },
            {
                ...
                text: `<ul class="menu-list">
                       ...
                       <div class="step-sub">コラゲナーゼは、準備中にクリーンベンチ内で解凍しておく。<br>解凍できたら、チビタンを一瞬回して壁面の液体を落とし、PBS (-) 10 ml 内に 100 µl を希釈する。</div>`
            },
        ...
        content: [
            {
                type: 'warning',
                title: '解剖時の注意',
                text: '心臓を切る際はハサミの刃を入れすぎないこと。<br>切断面の細胞は死滅して拍動しなくなるため、結果に大きく影響します。<br>また、作業に時間をかけすぎないようにしましょう。<br>時間がかかればかかるほど、拍動が弱まります。'
            },
            {
                type: 'step',
                list: [
                    { title: "心臓の摘出", sub: "<strong>左　：</strong>解剖機器を用いて、卵から胚を取り出し、胚から心臓を摘出する。<br>※摘出した心臓は、中央のシャーレに入った培地の中に移しましょう。<br><br><strong>中央：</strong>心臓周辺についている組織を除去し、心臓内部に入った血液を抜く。<br><br><strong>右　：</strong>心臓を2, 3個の塊に切り刻む。ただし、刃を入れすぎないよう注意すること。" },
                    { title: "組織の洗浄", sub: "10 ml オートピペッターで、心臓組織の入った培地を 15 ml チューブに移す。<br><br>心臓組織が自然に沈殿するのを待ち、十分に沈殿したのを確認したら、上清をアスピレーターで吸い取る。<br><br>PBS (-) 10 ml を加え、再度組織片が自然に沈殿を待ってから上清を吸う。<br><br>PBS (-) 5 ml を加え、再度組織片が自然に沈殿するのを待つ。<br>※ここでは、上清を除去しない。" },
                    { title: "コラゲナーゼ処理 (1回目)", sub: "<strong>コラゲナーゼ処理（1回目）の目的：</strong> <br>心臓周辺の冠動脈の除去。<br><br>PBS (-) 5 ml はなるべく吸わないよう注意しながら、組織片のみを滅菌瓶に移す。<br><br>※ただし、乾いているとオートピペッターで吸えないので、ほんの少しだけ先端にPBS (-)を入れてから、組織片を吸うようにするのがコツ。<br><br>オートピペッターは付け替えずにそのまま使って、希釈したコラゲナーゼ 10 ml 全量を滅菌瓶に入れる。<br><br>ウォーターバス内で <strong>37 ℃, 10 min</strong> 撹拌する。<br>※スターラーは細胞懸濁液が泡立たない程度のスピードで回転させる。" },
                    { title: "コラゲナーゼ処理 (2回目)", sub: "<strong>コラゲナーゼ処理（2回目）の目的：</strong> <br>組織内部への酵素浸透。<br><br>5 ml オートピペッターで上清（不要な組織片）を除く。<br><br>新しいコラゲナーゼ 10 ml を加え、2回だけピペッティングして軽く組織を崩してから、<strong>37 ℃, 20 min</strong> 撹拌する。<br>※このときはオートピペッターを使っても、直接入れるでも良い。" },
                    { title: "遠心分離", sub: "50 ml チューブにセルストレーナーをセットし、攪拌後の細胞懸濁液を通す。<br><br>FBSなしDMEMを加えて総量 35 ml の細胞懸濁液にする。<br><br><strong>1000 rpm, 5 min</strong> で遠心。" },
                    { 
                        title: "線維芽細胞の除去", 
                        sub: "上清をアスピレーターで吸い取る。<br><br>沈殿（ペレット）をFBSありDMEMで懸濁し、コルベン（フラスコ）に入れる。<br><br>※FBSありDMEMは、5 ml × コルベン枚数分だけ追加する。<br><br>位相差顕微鏡にセットして、十分に細胞数があることを確認する（吹雪のような状態だったらOK）<br><br><strong>37 ℃ で 20 min</strong> インキュベート。",
                        innerNote: { title: "CO2インキュベーターの役割", text: "庫内を CO2 5 % に保つことで培地中の炭酸イオン濃度を維持し、pHを一定に保つ。<br><br><strong>コルベン処理の効果</strong><br>接着能の高い線維芽細胞だけがコルベン底面に張り付き、接着能の低い心筋細胞は浮遊したまま残る。<br>ただし、長時間インキュベートしすぎると、良質な心筋細胞まで貼りついてしまうので注意。" }
                    },
                    { title: "心筋細胞の回収", sub: "顕微鏡をのぞき、線維芽細胞の仮足が伸び始めていることを確認する。<br>ただし、ここの張り付き具合が十分か否かは、経験数の多い学生に判断してもらうこと。<br><br>50 ml チューブにFBSなしDMEMを、総量 35 ml になるように入れる。<br>例）コルベン2枚の場合、コルベン内の細胞懸濁液が 10 ml になるはずなので、FBSなしDMEM 25 ml をチューブに入れる。<br><br>浮遊している心筋細胞を含んだ細胞懸濁液をコルベンから回収する。<br><br>チューブに移したFBSなしDMEMで、コルベン表面をウォッシュして、細胞を全て回収する。<br>ウォッシュは10回以上、念入りに行うこと。<br><br>再度、<strong>1000 rpm, 5 min</strong> で遠心。" },
                    { title: "カウント", sub: "ペレットが十分にあることを確認したのち、上清のみアスピレーターで除去する。<br><br>FBSありDMEM 100 µl をチューブに入れる。<br><strong>※チェックポイント：</strong><br>細胞数に応じて 100 µl 以上入れる場合もあるため、経験数の多い学生に確認をとること。<br><br>そうして作製した細胞懸濁液から 10 µl だけ、エッペンチューブに移す。<br><br>エッペンチューブにFBSありDMEMを 90 µl 入れて、10倍希釈する。<br><strong>※チェックポイント：</strong><br>ここも細胞数に応じて希釈倍率が変化するため、経験数の多い学生に確認をとること。<br><br>新たな別のエッペンチューブに、先ほど希釈した懸濁液 10 µl を移す。<br><br>そこにトリパンブルー 10 µl を入れ、2倍希釈する。<br><br>トリパンブルーで染色した細胞懸濁液を 10 µl だけとって、血球計算盤にいれ、細胞数をカウントする。<br><br><strong>※細胞数の計算方法：</strong><br>血球計算盤上の4区画の平均細胞数 × 希釈倍率（例：20倍） × 10^4（個）<br><br>目的の濃度（例: 1×10^7 cells/ml）になるよう細胞懸濁液を調製し、Dishに播種する。<br><strong>※チェックポイント：</strong><br>ここも慣れるまでは、経験数の多い学生に確認をとること。" },
                    { title: "播種", sub: "※単離中に、Dishにコラーゲンを播種し、30 min 以上インキュベートしておく。<br>※インキュベーター内で揮発しきらなかった場合は、クリーンベンチ内にて風をあてて完全に揮発させる。<br><br>PBS (-) 1 ml をDish内に添加し、すぐアスピレーターで除去する。<br>これにより、コラーゲンが繊維状になる。<br><br>DMEM 1 ml を入れ、Dish中心に向けて、細胞懸濁液を播種する。<br><br><strong>※参考までに播種量は、</strong><br>515 10 µl <br>545 20 µl<br>再度、<strong>1000 rpm, 5 min</strong> で遠心。" }
                ]
            }
        ]
    },
